...
<body>
 <%
 /*
 String savePath=application.getRealPath("/imgs"); // 업로드 파일을 저장할 폴더 지정 
...
Timestamp signdate = new Timestamp(System.currentTimeMillis());
 ...
 try{
 	...
 	String sql = "insert into mating (name,subject,comment,signdate,ref,img,good) values(?,?,?,?,?,?,?)";
...
<meta http-equiv='Refresh' content='0; URL=index.jsp?target=mating'>
