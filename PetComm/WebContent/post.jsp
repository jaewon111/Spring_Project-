...
Timestamp signdate = new Timestamp(System.currentTimeMillis());
 ...
 try{
 	...
 	String sql = "insert into freeboard (name,subject,comment,signdate,ref,img,good) values(?,?,?,?,?,?,?)";
 ...
 %>
<meta http-equiv='Refresh' content='0; URL=index.jsp?target=rboard&lang=<%=lang%>'>
</body>
</html>