...
Timestamp signdate = new Timestamp(System.currentTimeMillis());
 ...
 try{
 	...
 	String sql = "insert into reviewreplylist (fid,name,comment,signdate) values(?,?,?,?)";
 ...
 %>
<meta http-equiv='Refresh' content='0; URL=index.jsp?target=view&lang=<%=lang%>&number=<%= number%>'>
</body>
</html>