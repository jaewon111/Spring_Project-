...
namespace A_3_EduMgr
{
    public partial class Form3 : MetroForm
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            var Conn = new OleDbConnection(Constr);
            Conn.Open();
            var Comm = new OleDbCommand("Select name, edunum, birth, email, phone, userid from t_userinfo where edunum = " + EudNum + "", Conn);
            ...
            var Conn2 = new OleDbConnection(Constr);
            Conn2.Open();
            var Comm2 = new OleDbCommand("Select userpwd from t_login where userid = '" + txtId.Text + "'", Conn2);
