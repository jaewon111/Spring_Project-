    ...
    public partial class Form5 : MetroForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Conn.Open();
                var Comm01 = new OleDbCommand("Select userid from t_userinfo where edunum = '" + txtEdunum.Text + "'", Conn);
        ...
        private void btnpfind_Click(object sender, EventArgs e)
        {
            try
            {
                var Conn1 = new OleDbConnection(Constr);
                Conn1.Open();
                var Comm011 = new OleDbCommand("Select A.userpwd from t_login A,t_userinfo B where A.userid = '" + txtPid.Text + "' and B.name = '"+ txtPname.Text +"'  ", Conn1);
