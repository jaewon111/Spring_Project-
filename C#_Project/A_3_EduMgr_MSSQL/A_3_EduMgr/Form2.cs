...
namespace A_3_EduMgr
{
    public partial class Form2 : MetroForm
    {
        ...
        private void SubjectLoad()
        {
            ...
            var Comm = new SqlCommand("Select subject from t_subject where category = '전공'", Conn);
            ...
            var Comm03 = new SqlCommand("Select subject from t_subject where category = '교양'", Conn);
