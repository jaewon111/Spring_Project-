...
Timestamp signdate = new Timestamp(System.currentTimeMillis());
 ...
 try{
 	...
 	String sql = "insert into mating_replylist (fid,name,comment,signdate) values(?,?,?,?)";
 ...
 %>
<meta http-equiv='Refresh' content='0; URL=index.jsp?target=qsmatingview&lang=<%=lang%>&number=<%=number%>'>
</body>
</html>