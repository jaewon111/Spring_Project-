					...
					<br>
									<%
									 ...
									 try
									 {
									  ...
									  String sqlcount="select count(*) from reviewreplylist where name='" +id + "'";
									  ...
									  while(rs.next())
									  {
										...
										String sqlList = "select  fid,comment,signdate from reviewreplylist where name='" + id  + "'order by uid DESC";
									            ...
									            <tr >
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										            			int fid = rs.getInt(1);  //글번호
										                		String comment = rs.getString(2); //제목
										                		String signdate = rs.getString(3);//작성시간
										                %>               
										                  <td width="70%" align="center"><a href="index.jsp?target=view&number=<%= fid%>"><%=comment %></a></td>
						...
						<br>
									...
									<%
									 ...
									 try
									 {
									  conn=DriverManager.getConnection(url,rid,pass);
									  Statement stmt=conn.createStatement();
									  String sqlcount="select count(*) from replylist where name='" +id + "'";
									  rs=stmt.executeQuery(sqlcount);
									  ...
									  while(rs.next())
									  {
										...
										String sqlList = "select  fid,comment,signdate from replylist where name='" + id  + "'order by uid DESC";
										            ...
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										                		...
										                		String signdate = rs.getString(3);//작성시간
										                %>               
										                  <td width="70%" align="center"><a href="index.jsp?target=qsview&number=<%= fid%>"><%=comment %></a></td>
										                    <td width="20%" align="center"><%= signdate %></td>
						...
						<br>
									...
									int total_three=0;
									 try
									 {
									  conn=DriverManager.getConnection(url,rid,pass);
									  Statement stmt=conn.createStatement();
									  String sqlcount="select count(*) from boastreplylist where name='" +id + "'";
									  rs=stmt.executeQuery(sqlcount);
									  ...
									  while(rs.next())
									  {
										...
										String sqlList = "select  fid,comment,signdate from boastreplylist where name='" + id  + "'order by uid DESC";
										            ...
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										                		...
										                		String signdate = rs.getString(3);//작성시간
										                %>               
										                  <td width="70%" align="center"><a href="index.jsp?target=boastview&number=<%= fid%>"><%=comment %></a></td>
										                    <td width="20%" align="center"><%= signdate %></td>
										                </tr>
										                <%
									            			}
						...
						<br>
									...
									int total_four=0;
									 ...
									 try
									 {
									  conn=DriverManager.getConnection(url,rid,pass);
									  Statement stmt=conn.createStatement();
									  String sqlcount="select count(*) from mating_replylist where name='" +id + "'";
									  rs=stmt.executeQuery(sqlcount);
									
									  while(rs.next())
									  {
										  total_four = rs.getInt(1);
									  }
										rs.close();
										out.print("총 게시글:" + total_four + "개");
									
										String sqlList = "select  fid,comment,signdate from mating_replylist where name='" + id  + "'order by uid DESC";
										            ...
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										                		...
										                		String signdate = rs.getString(3);//작성시간
										                %>               
										                  <td width="70%" align="center"><a href="index.jsp?target=qsmatingview&number=<%= fid%>"><%=comment %></a></td>
										                    <td width="20%" align="center"><%= signdate %></td>
										                </tr>
										                <%
									            			}
