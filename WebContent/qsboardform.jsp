...
<form class="form-horizontal" role="form"  method="post" action="index.jsp?target=qsboardpost&lang=<%=lang%>" enctype="Multipart/form-data">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<a href="index.jsp?target=qsboard&lang=<%=lang%>"><button type="button" class="btn btn-default"><% if(lang.equals("korea")){%>취소<%}else if(lang.equals("china")){%>取消 <%}else if(lang.equals("america")){%>Cancel<%}   %></button> </a>
		</div> 
	</div> 
</form>
	<%
