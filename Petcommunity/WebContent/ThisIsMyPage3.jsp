					...
					<br>
					            	...
					            	int ref = 0;
									 ...
									 try
									 {
									  ...
									  String sqlcount="select count(*) from freegood where name='" +id + "'";
									  ...
									  while(rs.next())
									  {
										...
										String sqlList = "select  uid from freegood where name='" + id  + "'order by uid DESC";
										            ...
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										            			...
										            			sqlList = "select  uid,subject,signdate,ref from freeboard where uid='" + uid  + "'order by uid DESC";
															    rs2 = stmt3.executeQuery(sqlList);
															    
															    while(rs2.next())
															    {
															    	uid = rs2.getInt(1);  //글번호
												            		subject = rs2.getString(2); //제목
												            		signdate = rs2.getString(3);//작성시간
												            		ref = rs2.getInt(4); //조회수 
															    }
															    rs2.close();
						...
						<br>
									...
									<%
									 ...
									 try
									 {
									  ...
									  String sqlcount="select count(*) from qsgood where name='" +id + "'";
									  rs=stmt.executeQuery(sqlcount);
									  ...
									  while(rs.next())
									  {
										...
										String sqlList = "select  uid from qsgood where name='" + id  + "'order by uid DESC";
										            ...
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										            			...
										            			sqlList = "select  uid,subject,signdate,ref from reboard where uid='" + uid  + "'order by uid DESC";
															    rs2 = stmt2.executeQuery(sqlList);
						...
						<br>
									...
									<%
									 ...
									 try
									 {
									  ...
									  String sqlcount="select count(*) from boastgood where name='" +id + "'";
									  rs=stmt.executeQuery(sqlcount);
									  ...
									  while(rs.next())
									  {
										...
										String sqlList = "select  uid from boastgood where name='" + id  + "'order by uid DESC";
										            ...
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										            			...
										            			sqlList = "select  uid,subject,signdate,ref from boast where uid='" + uid  + "'order by uid DESC";
															    rs2 = stmt4.executeQuery(sqlList);
						...
						<br>
									...
									<%
									 ...
									 try
									 {
									  ...
									  String sqlcount="select count(*) from matinggood where name='" +id + "'";
									  rs=stmt.executeQuery(sqlcount);
									  ...
									  while(rs.next())
									  {
										...
										String sqlList = "select  uid from matinggood where name='" + id  + "'order by uid DESC";
										            ...
										            <%
										            	...
										            	else
										            	{
										            		while(rs.next())
										            		{
										            			...
										            			sqlList = "select  uid,subject,signdate,ref from mating where uid='" + uid  + "'order by uid DESC";
															    rs2 = stmt5.executeQuery(sqlList);
